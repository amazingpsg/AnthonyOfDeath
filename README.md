# 🌌 Bardo 3D Slide Viewer

> **"의식의 끊어지지 않는 프랙탈 여정"**  
> 티베트 사자의 서(The Tibetan Book of the Dead)에 담긴 6가지 바르도를 동적이고 세련된 3D Carousel 인터랙션으로 시각화한 프리미엄 정적 웹 뷰어 프로젝트입니다.
...
- **Full Interactive Controls**:
  - **마우스 휠(Mouse Wheel)** 스크롤을 감지해 부드러운 슬라이드 전환 지원
  - **키보드 방향키(←, →)** 및 화면 좌우 화살표 버튼 제어
  - **하단 썸네일(Thumbnail)** 트랙 연동으로 개별 슬라이드 빠른 이동
